...
```{r inférence multimodèle}
evidence(aic.table = aictab(cand.set = Cands, modnames = Model.names))
modavg(cand.set = Cands, modnames = Model.names, parm = "Eau", parm.type = "psi")
modavg(cand.set = Cands, modnames = Model.names, parm = "Route", parm.type = "psi")
coef(mQE)
modavg(cand.set = Cands, modnames = Model.names, parm = "qualitegood", parm.type = "detect")
```
...
#predict(mQE, newdata = predData, se.fit = TRUE, type = "link")

modavgPred(cand.set = Cands, modnames = Model.names, newdata = predData, parm.type = "psi")
```
